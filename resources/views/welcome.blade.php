...
<div class="home-section img-top align-middle container-fluid home-bg-top text-center"
    style="background-image: url('{{ asset('img/home-bg.jpg')}}');">
    <img src="{{asset('img/ananta.png')}}" class="img-border selector" />
    <div class="bg-header-text">
        <p class="text-center home-font text-white"><b>คลินิกทางเลือกสมุนไพรเพื่อสุขภาพ</b></p>
        <p class="text-center home-font text-white"><b>Traditional Alternative Medicine Clinic</b>
        </p>
    </div>
</div>
<section class="container">
    ...
    <br>
    <div class=" row justify-content-between animation-element slide-right align-items-center d-flex ">
